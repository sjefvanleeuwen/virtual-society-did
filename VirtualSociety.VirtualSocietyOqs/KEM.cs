...
namespace VirtualSociety.VirtualSocietyOqs
{
    ...
    public class KEM : Mechanism
    {
        ...
        static KEM()
        {
            ...
            EnabledMechanisms = enabled.ToImmutableList();
            SupportedMechanisms = supported.ToImmutableList();
        }
        ...
        public ulong PublicKeyLength
        {
            get
            {
                return (ulong)oqs_kem.length_public_key;
            }
        }
        ...
        public ulong SecretKeyLength
        {
            get
            {
                return (ulong)oqs_kem.length_secret_key;
            }
        }
        ...
        public ulong CiphertextLength
        {
            get
            {
                return (ulong)oqs_kem.length_ciphertext;
            }
        }
        ...
        public ulong SharedSecretLength
        {
            get
            {
                return (ulong)oqs_kem.length_shared_secret;
            }
        }
