...
namespace VirtualSociety.VirtualSocietyOqs
{
    ...
    public class Sig : Mechanism
    {
        ...
        public ulong PublicKeyLength
        {
            get
            {
                return (ulong)oqs_sig.length_public_key;
            }
        }
        ...
        public ulong SecretKeyLength
        {
            get
            {
                return (ulong)oqs_sig.length_secret_key;
            }
        }
        ...
        public ulong SignatureLength
        {
            get
            {
                return (ulong)oqs_sig.length_signature;
            }
        }
        ...
        public void sign(out byte[] signature, byte[] message, byte[] secret_key)
        {
            ...
            Array.Resize(ref my_signature, (int)sig_len_ptr.ToUInt64());
